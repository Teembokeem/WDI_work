...
class Android extends Human {
  ...
  roboHate() {
    return `what is this life but a kiss from a rose, petty human?`
  }
  freakOut() {
    return `argggggggg i am angry with my lifespan of ${this.health_years}`
  }
}

var yael = new Android("Yael", "developer");

console.log(yael.roboHate());
console.log( yael.freakOut());
console.log( yael.atAParty());
