...
var declaim = function(king) {
  return "Woe be to the pretender " + king.name + " of the house " +
         king.house + "...";
};
...
kings.forEach(function(king) {
  // king.ironThrone ? console.log(hailTo(king)) : console.log(declaim(king));
  ...
  console.log(king.ironThrone ? hailTo(king) : declaim(king));
});
...
var kneel = function(king) {
  ...
  return "The " + title + " " + king.name + " of house " + king.house +
         " must kneel!"
}
