...
class HorsesControllerTest < ActionController::TestCase
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post :create, horse: { age: @horse.age, name: @horse.name, shoed: @horse.shoed, user_id: @horse.user_id }
    end
  ...
  test "should update horse" do
    patch :update, id: @horse, horse: { age: @horse.age, name: @horse.name, shoed: @horse.shoed, user_id: @horse.user_id }
    assert_redirected_to horse_path(assigns(:horse))
  end
